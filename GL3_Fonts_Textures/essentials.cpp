...
//Camera Stuff
int current_view;
glm::vec3 cam_eye, cam_tar, cam_up;
glm::vec3 top_view_eye, top_view_tar, top_view_up;
...
// Base params
GLfloat block_l, block_b, block_h;
GLfloat dx, dy, dz;
int layout[10][10] = {};
GLfloat base_top_R, base_top_G, base_top_B;
GLfloat base_bottom_R, base_bottom_G, base_bottom_B;
